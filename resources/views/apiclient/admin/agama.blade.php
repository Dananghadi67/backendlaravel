                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{url('/client/admin30/data-agama30/edit30')}}-{{$item['id']}}"
                                    class="text-success mx-2"><i class="fa fa-edit fa-lg"></i></a>
                                <a href="{{url('/client/admin30/data-agama30/delete30')}}-{{$item['id']}}"
                                    class="text-danger mx-2"><i class="fa fa-trash fa-lg"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
        ...
        <div class="modal fade" id="tambah-agama">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="/client/admin30/data-agama30/create30" method="POST">
                        @csrf
