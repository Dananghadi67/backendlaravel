        ...
        <div class="form sign-in-container">
            <form method="POST" action="{{ route('register') }}" class="myForm text-center">
                ...
                <div class="form-group">
                    <input class="myInput @error('name') is-invalid @enderror" type="text" placeholder="Fullname"
                        id="fullname" name="name" value="{{ old('name') }}" required autocomplete="name" />
                    @error('name')
                ...
                <div class="form-group">
                    <input class="myInput" type="password" placeholder="Password Confirmation"
        ...
        <div class="overlay-container">
            <div class="overlay">
                <div class="overlay-panel overlay-right">
                    <h1>Log In</h1>
                    <p>Log In here if you have account.</p>
                    <a href="/login30"><button class="signup_btn">Log In</button></a>
                </div>
            </div>
        </div>
    </div>
