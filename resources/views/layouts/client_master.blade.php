...
<html lang="en">
    ...
    <body class="hold-transition dark-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
        <div class="wrapper">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
               ...
               with font-awesome or any other icon font library -->
                            <li class="nav-item @php if(\Request::path() == 'client/admin30/dashboard30')echo "
                                menu-open" @endphp">
                                <a href="/client/admin30/dashboard30" class="nav-link">
                            ...
                            <li class="nav-item @php if(\Request::path() == 'client/admin30/data-agama30')echo "
                                menu-open" @endphp">
                                <a href="/client/admin30/data-agama30" class="nav-link">
                            ...
                            <li class="nav-item">
                                <a href="/logout30" class="nav-link">
        ...
        <script src="{{asset('assets/assets/dist/js/pages/dashboard2.js')}}"></script>
        <!-- AdminLTE App -->
