        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        <li
                            class="nav-item @php if(\Request::path() == 'admin30/dashboard30')echo " menu-open" @endphp">
                            <a href="/admin30/dashboard30" class="nav-link">
                        ...
                        <li
                            class="nav-item @php if(\Request::path() == 'admin30/data-agama30')echo " menu-open" @endphp">
                            <a href="/admin30/data-agama30" class="nav-link">
