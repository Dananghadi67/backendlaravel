        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
               ...
               with font-awesome or any other icon font library -->
                            <li class="nav-item @php if(\Request::path() == 'admin30/dashboard30')echo " menu-open"
                                @endphp">
                            ...
                            <li class="nav-item @php if(\Request::path() == 'admin30/data-agama30')echo " menu-open"
                                @endphp">
